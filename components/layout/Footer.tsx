    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">เกี่ยวกับเรา</h3>
            <p className="text-sm">
              ร้านขายเสื้อผ้าออนไลน์ คุณภาพดี ราคาย่อมเยา ส่งไวทั่วประเทศ
            </p>
          </div>
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-white font-bold text-lg mb-4">บริการลูกค้า</h3>
            <ul className="space-y-2 text-sm">
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>อีเมล: contact@fashionstore.com</li>
